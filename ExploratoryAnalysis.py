...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 16 12:46:51 2018
...
# list 2-6 Parallel Coordinates Graph for Real Attribute Visualization
for i in range(208):
...
# list 2-7 Cross Plotting Pairs of Attributes
...
# list 2-8 Correlation between Classification Target and Real Attributes
...
#list 2-9 Pearson’s Correlation Calculation for Attributes 2 versus 3 and 2 versus 21
#calculate correlations between real-valued attributes
dataRow2 = rocksVMines.iloc[:,1]
dataRow3 = rocksVMines.iloc[:,2]
dataRow21 = rocksVMines.iloc[:,20]
...
# list 2-10 Presenting Attribute Correlations Visually
